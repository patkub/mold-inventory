/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b7cb7e5509f2e8b0e8f0365891a5017b)
// Runtime types generated with workerd@1.20260219.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		API_BASE_URL: "https://mold-inventory-api-production.epicpatka.workers.dev";
		AUTH0_CLIENT_SECRET: string;
		COOKIE_ENCRYPTION_KEY: string;
		NODE_ENV: string;
		MCP_OBJECT: DurableObjectNamespace /* MoldsMCP */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH0_DOMAIN" | "AUTH0_CLIENT_ID" | "AUTH0_AUDIENCE" | "AUTH0_SCOPE" | "API_BASE_URL" | "AUTH0_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY" | "NODE_ENV">> {}
}
