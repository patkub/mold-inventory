        ...
        <div class="container">
          <div class="card">
            <div class="header">
              ...
              <h1>Molds MCP Server - Authorization Request</h1>
              <a href="${clientUri}" target="_blank" rel="noopener noreferrer" class="app-link">${clientName}</a>
            </div>

            <p class="description">
              <strong>${clientName}</strong> is requesting permission to access the <strong>Molds API</strong> using your account. Please
            ...
            <p class="description">
              If you did not initiate the request coming from <strong>${clientName}</strong> (<i>${redirectUri}</i>) or you do not trust
              this application, you should deny access.
            </p>
